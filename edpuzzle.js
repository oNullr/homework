...
function init() {
  if (window.location.hostname == "edpuzzle.hs.vc") {
    alert("To use this, drag this button into your bookmarks bar. Then, run it when you're on an Edpuzzle assignment, dumbass.");
  }
    ...
    alert("Run this shit on Edpuzzle assignment u dumbass");
  }
}
...
function handleCanvasURL() {
  ...
  http_get(url, function(){
    ...
    http_get(url2, function() {
      ...
      alert(`Please re-run this script in the newly opened tab. If nothing happens, then allow popups on Canvas and try again, dumb shit.`);
      open(url3);
    });
  });
}
...
function handleSchoologyURL() {
  ...
  http_get(url, function() {
    alert(`Please re-run this script in the newly opened tab. If nothing happens, then allow popups on Schoology and try again, dumb shit.`);
...
function openPopup(assignment) {
  ...
  <div id="header_div">
    ...
    <div id="title_div">
      ...
      <input id="skipper" type="button" value="Skip the god damn video" onclick="skip_video();" disabled/>
      <input id="answers_button" type="button" value="answer all the questions for you :)" onclick="answer_questions();" disabled/>
  ...
  <hr>
  <p style="font-size: 0px">Made by: <a target="_blank" href="https://github.com/ading2210">ading2210</a> on Github | Website: <a target="_blank" href="https://edpuzzle.hs.vc">edpuzzle.hs.vc</a> | Source code: <a target="_blank" href="https://github.com/ading2210/edpuzzle-answers">ading2210/edpuzzle-answers</a></p>
  <p style="font-size: 0px">Licenced under the <a target="_blank" href="https://github.com/ading2210/edpuzzle-answers/blob/main/LICENSE">GNU GPL v3</a>. Do not reupload or redistribute without abiding by those terms.</p>
  <p style="font-size: 0px">Available now from our <a target="_blank" href="https://edpuzzle.hs.vc/discord.html">Discord server</a>: <i> An open beta of a completely overhauled GUI, with proper mobile support, ChatGPT integration for open-ended questions, and more. </i></p>`;
